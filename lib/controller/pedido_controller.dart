...
class PedidoController {
  ...
  adicionar(context, Pedido p) {
    ...
    .catchError((e) => erro(context, 'Não foi possível adicionar o pedido'))
  ...
  atualizar(context, uid, Pedido p) {
    ...
    .catchError((e) => erro(context, 'Não foi possível atualizar o pedido'))
    .whenComplete(() => Navigator.pop(context));
  }
  ...
  excluir(context, uid) {
    ...
    .doc(uid)
    .delete()
    .then((value) => sucesso(context, 'Pedido excluido com sucesso!'))
    .catchError((e) => erro(context, 'Não foi possível excluir o pedido'));
  }
